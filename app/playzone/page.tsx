...
const AGE_GROUPS = [
  ...
  },
  {
    ...
    bg: "#fdf0ee",
    border: "#f5b8b0",
    desc: "Applied thinking challenges — harder distractors, crop rotation, carbon footprints, and food systems.",
    games: 25,
  ...
  },
  {
    ...
    bg: "#eef1fc",
    border: "#c0cbf0",
    desc: "Case studies, deep conceptual challenges — agribusiness, climate policy, AgriTech, and real-world scenarios.",
    games: 25,
      ...
      <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#F5F5E8" }}>
        ...
        <div className="hero">
          ...
          <div className="hero-inner">
            ...
            <h1 className="hero-title">Learn. Play.<br /><span>Win Rewards.</span></h1>
            <p className="hero-sub">Play sustainability games, complete eco-challenges, earn LIFEWS Points, and win real prizes — garden kits, courses, cash, and more.</p>
            ...
            <div className="hero-stats">
              {[["100+","Games available"],["4","Play modes"],["5","Categories each"],["3","Difficulty levels"],["∞","Prizes to win"]].map(([n,l])=>(
        ...
        <div style={{ background: "#fff" }}>
          <div className="section">
            ...
            <p className="sec-sub">Every age group plays through the same 5 themed categories — at the right depth for their level.</p>
        ...
        <div id="age-groups" style={{ background: "#F5F5E8" }}>
          <div className="section">
            ...
            <h2 className="sec-title">Games for every age</h2>
            <p className="sec-sub">From nursery to senior secondary — everyone has their own PlayZone with age-appropriate challenges.</p>
        ...
        <div className="how-section">
          <div className="how-inner">
            ...
            <div className="how-grid">
              {[
                {n:"1",title:"Choose your level",desc:"Select your mode — Seedlings, Sprouts, Blazers, or Thinkers — matched to your age and ability."},
        ...
        <div className="rewards-section">
          <div className="rewards-inner">
            ...
            <p style={{fontSize:15,color:"rgba(255,255,255,0.6)",fontWeight:300,lineHeight:1.7,maxWidth:540}}>Every point you earn brings you closer to something real — from digital badges to garden kits and cash prizes.</p>
        ...
        <div className="badges-section">
          <div className="badges-inner">
            ...
            <p className="sec-sub">Earn badges as you complete challenges. Show them off on your profile.</p>
        ...
        <div className="lb-section">
          <div className="lb-inner">
            ...
            <p style={{fontSize:15,color:"rgba(255,255,255,0.6)",fontWeight:300,lineHeight:1.7,marginBottom:32}}>Individual scores combine into school rankings. Weekly and monthly winners get special prizes.</p>
            <div className="lb-grid">
              <div className="lb-card">
                <div className="lb-title">🏆 Top Students This Week</div>
                {[["1","Amara O.","12,450 pts"],["2","Kofi M.","11,200 pts"],["3","Fatima A.","10,800 pts"],["4","Emeka J.","9,650 pts"],["5","Zara L.","9,100 pts"]].map(([rank,name,pts])=>(
              ...
              <div className="lb-card">
                ...
                {[["1","Greenfield Primary, Lagos","245,000 pts"],["2","Unity Academy, Abuja","231,500 pts"],["3","Eden School, Accra","218,200 pts"],["4","Sunrise College, Nairobi","204,700 pts"],["5","Forest Intl, Cape Town","198,300 pts"]].map(([rank,name,pts])=>(
                  <div key={rank} className="lb-row">
                    <div className="lb-rank">{rank}</div>
                    <div className="lb-name">{name}</div>
                    <div className="lb-pts">{pts}</div>
        ...
        <div className="sub-section">
          <div className="sub-inner">
            ...
            <p className="sec-sub">Play for free with selected games, or unlock the full LIFEWS PlayZone experience.</p>
            <div className="sub-grid">
              {[
                {name:"Free",price:"₦0",period:"Always free",featured:false,features:["2 games per category","Basic LIFEWS Points","Public leaderboard","Community badges","Selected challenges"]},
                {name:"Premium",price:"₦1,500",period:"per month",featured:true,features:["All 100+ games","Full LIFEWS Points rewards","Advanced leaderboard","Certificates","Premium tournaments","Priority prize access"]},
                {name:"School",price:"₦15,000",period:"per term",featured:false,features:["Whole school access","Teacher dashboard","Class & school rankings","Inter-school competitions","Analytics & reports","Custom challenges"]},
                {name:"Family",price:"₦3,000",period:"per month",featured:false,features:["2 parents + 3 children","Shared family points","Family leaderboard","Home garden challenges","Green Family badge","Family certificates"]},
              ].map(p=>(
